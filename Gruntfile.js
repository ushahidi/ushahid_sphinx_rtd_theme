  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'ushahidi_sphinx_rtd_theme/static/fonts/',
              filter: 'isFile'
          },
          {
              expand: true,
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'ushahidi_sphinx_rtd_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'ushahidi_sphinx_rtd_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    clean: {
      ...
      fonts: ["ushahidi_sphinx_rtd_theme/static/fonts"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['ushahidi_sphinx_rtd_theme/**/*', 'demo_docs/**/*.rst', 'demo_docs/**/*.py'],
